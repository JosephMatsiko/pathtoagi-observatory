...
out.push('Read live: /record.json (full machine-readable record), /status/ (operating state), /reproduce/ (verification path), or the MCP server (mcp/observatory-server.mjs). Channels: /to-the-systems-reading-this/\n');
